...
class Game {
    constructor(numberOfDisks) {
        ...
        // this.rods = []
        // this.rods.push(new Rod('A', numberOfDisks, numberOfDisks))
        // this.rods.push(new Rod('B', 0, numberOfDisks))
        // this.rods.push(new Rod('C', 0, numberOfDisks))
        this.numberOfMoves = 0
    }
    move(sourceRodId, targetRodId) {
        let sourceRod = this.rods[sourceRodId]
        let targetRod = this.rods[targetRodId]
        // let sourceRod = this.rods.find(rod => rod.id == sourceRodId)
        // let targetRod = this.rods.find(rod => rod.id == targetRodId)
